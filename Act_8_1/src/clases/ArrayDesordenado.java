/**
 * Clase ArrayDesordenado en la que definimos un atributo de un array y otro de
 * un entero final que será siempre -9 y que le daremos el nombre de NULO.
 * Estarán los métodos para insertar un número en el array, borrar un numero dado
...
public class ArrayDesordenado {
	...
	/**
	 * Metodo toString de la clase ArrayDesordenado
	 */
